...
// --- NEW: Carrier Logo Imports ---
// We import the images from your src/img/ folder
import amazonLogo from './img/Amazon.png';
import australiaPostLogo from './img/Australia post.webp';
import dhlLogo from './img/DHL.png';
import dpdLogo from './img/DPD.png';
import royalMailLogo from './img/Royal-Mail-Logo-2001.png';
import canadaPostLogo from './img/canada post.webp';
import evriLogo from './img/evri.webp';
import fedexLogo from './img/fedex.png';
import upsLogo from './img/ups.png';
import uspsLogo from './img/usps.png';

// --- NEW: Logo Mapping ---
// This object maps the carrier name to the imported logo
const carrierLogos = {
  'Amazon': amazonLogo,
  'Australia Post': australiaPostLogo,
  'DHL': dhlLogo,
  'DPD': dpdLogo,
  'Royal Mail': royalMailLogo,
  ...
  if (logo) {
    return (
      <img
        src={logo}
        alt={`${carrier} logo`}
        className={`${sizeClass} rounded-lg object-contain bg-white dark:bg-gray-100 p-1 shrink-0`}
      />
    );
  }

  // Fallback for carriers without a logo
  return (
    <div className={`${sizeClass} rounded-lg flex items-center justify-center shrink-0 bg-gray-300 dark:bg-gray-600`}>
      <Package className={`${iconSizeClass} text-gray-600 dark:text-gray-300`} />
    </div>
  );
};
...
// UPDATED: Carrier list to match logos
const carriers = ['UPS', 'FedEx', 'USPS', 'Amazon', 'DHL', 'Royal Mail', 'Evri', 'DPD', 'Canada Post', 'Australia Post'];
...
const CouriersPage = () => {
  ...
  // UPDATED: To match imported logos
  const couriersData = [
    { 
      name: 'UPS', 
      id: 'UPS', 
    ...
    { 
      name: 'Purolator', 
      id: 'Purolator', // Will use fallback icon
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select name="carrier" id="carrier" value={formState.carrier} onChange={handleFormChange} required
                ...
                {/* UPDATED: Use the new carriers list */}
